...
- **文内一级标题**：应能看出主题与体裁，与文件名同向；避免过宽的讲座名（如「前沿科技与颠覆式创新」）。文件名是检索键，标题是阅读入口，二者不必逐字相同，但不得指到另一篇文章。
...
每篇文档开头都有 `>` 引用的「直接答案」——只读这些，约 30 分钟可扫完。若某篇引起兴趣，再沿目录深入。宽表格与 ASCII 图请用等宽字体、宽屏阅读。
