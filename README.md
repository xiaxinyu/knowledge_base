...
面向**数字时代工程与治理**的个人知识库。所守不是某一版本的配置，而是**何以如此**：历史从何处来，结构因何而立，治理凭何而信，智能向何处去，价值凭何而胜。

张之洞《劝学篇》所谓「中学为体，西学为用」：体是问法与准则——本末、阴阳、势道术；用是工艺与路径——架构、治理、智能与战略。有体无用则空，有用无体则乱。
...
| 章 | 内容 | 用途 |
|----|------|------|
| [1. 立意与三境](#1-立意与三境) | 为何建库、体用、取势 / 明道 / 优术 | 先明本末 |
| [2. 分区与编号](#2-分区与编号) | Johnny Decimal、区号、预留 | 先定地图 |
| [3. 检索与阅读](#3-检索与阅读) | 索引、概念反查、角色路径 | **日常入口** |
| [4. 文稿体例](#4-文稿体例) | 命名、体裁、读写纪律 | 增补时用 |
| [5. 术语](#5-术语) | 全库缩写首选写法 | 查表 |
| [6. 收束](#6-收束) | 跨篇河床与态度 | 收束 |

日常用法：打开本文 → [§3 检索与阅读](#3-检索与阅读) → 扫触发器或概念反查 → 读该篇「直接答案 / 摘要」→ 感兴趣再沿目录深入。若只要跨篇总纲，先读 [§6.1 跨篇河床](#61-跨篇河床)。
...
技术日新月异，工具朝生暮死。道家言「无为而无不为」：并非无所作为，而是不逆势妄为、不离道炫术。庄子叹「吾生也有涯，而知也无涯」——与其追逐浪尖上的名词，不如循势而行、据道而立、以术而成。本库所志，正在于此三境：

| 境界 | 所求 | 在技术中的含义 |
|------|------|----------------|
| **取势** | 察大势、顺时变 | 读懂计算、信息、智能与权力秩序的长河；知所从来，方知所往 |
| **明道** | 见本源、立准则 | 辨架构何以立身、治理何以可信、设计何以可久 |
| **优术** | 精方法、致实用 | 把原则落成可试点的工艺、护栏与路径；个人变快之后，组织如何承接 |

《道德经》云：「道生一，一生二，二生三，三生万物。」势为时，道为理，术为器——三者相生，缺一则偏：有术无道，则技巧失据；有道无势，则理想空悬；有势无术，则机遇空过。中学之体贯此三问，西学之用成其器，与三境相须。

荀子亦云：「不闻不若闻之，闻之不若见之，见之不若知之，知之不若行之。」此处文字，意在打通闻见与知行。各篇开篇判断是「知」的入口；跨篇仍站得住的余数，见 [§6.1](#61-跨篇河床)。

### 1.1 取势：观变于未发

《鬼谷子》言：「故圣人趋时；时有所宜，而事有所适。」势者，时代之流向也。

计算从专用机械走向按需资源池；信息被度量的是不确定性的减少，不是日常所谓「意义」；智能七十余年是锯齿线，寒冬多半是承诺跑得比当时能力快。服务架构从原始分布式到无服务，每一代「新范式」皆因上一代之势已穷。

权力秩序上，荷→英→美是公共品接力，不是兵力奖牌；第一次工业革命是改写生产可能的奇点，不能用「后来领先」证明「从来领先」。

不明势，则易把偶然当必然，把营销当定律，把交叠点当成爆发之年、把过渡当成已经交棒。明势，则能在浪潮中分辨：何为河床，何为泡沫。
...
企业架构回答「战略如何翻译为可执行安排」，并持续约束该建什么：教学可用四大域对齐，实践常见六层，价值在沟通与调整，不在照搬某一框架。COBIT 回答「价值、风险、资源如何在治理层被看清」：治理与管理必须分离。Unix 到 Agent 的哲学回答「工具应如何自处」：职责明确、可组合、可观察；遗忘有时强于记忆。

跨节点之后，强一致与持续可用必须取舍。控制是搬运熵；系统是要素、连接与目标。《周易》曰：「一阴一阳之谓道。」治理与管理、一致与可用、记忆与遗忘，皆两端相成，不可据一端而废另一端。明道，是在万变中守住那几条不轻易动摇的原则——守的是中道，不是某一极。
...
AI 降低了写出代码与生成预测的边际成本，却未必提高组织交付，更不等于自动好决策。个人之术已进，组织之道未立，则吞吐会被评审、联调与治理吸收；能力与业务需求之间，往往还隔着一道死亡之谷。

魏徵《谏太宗十思疏》：「善始者实繁，克终者盖寡。」开篇、立项、引入新器，人人能做；把原则落成可核对的试点，把被放大的速度交给组织承接，才是克终。此谷所以常见，不是不会开始，而是鲜克有终。

优术，不是堆砌更多工具或更多 Agent——堆人不是加法——而是让角色、工艺、流程、资产、平台与护栏，共同承接被放大的速度。

落到产业，护城河在专有数据与主流程；无法被廉价计量吞掉的判断、创意与信任，才有剩余溢价。落到运行，可核对的是压缩可证据化的恢复时间，而不是承诺无人值守。落到市场，竞争战略与文化译介把技术能力写成可被理解的价值。

> **优术，是对落地的忠诚**：无势之术是盲动，无道之术是投机；有势有道，术乃可精。

次序不可颠倒：先取势以定「现在在哪」，再明道以立「什么不可动摇」，后优术以致「这一步如何试点」。

---

## 2. 分区与编号

文稿不按日期罗列，而按**取势 → 明道 → 优术**排布——先观云起，再识山骨，终习登法。物理目录用 **Johnny Decimal**：十位为知识域，个位为域内顺序，中间预留空号，便于插入而不打乱既有编号。

```
knowledge_base/
├── 10-chronicle/       取势 · 史
├── 20-architecture/    明道 · 构
├── 30-governance/      明道 · 治
├── 40-paradigm/        优术 · 智
└── 50-strategy/        优术 · 略
```
...
| 区号 | 目录 | 境界 | 线索 | 所问 |
|------|------|------|------|------|
| **10** | `10-chronicle/` | 取势 | 史 | 计算、信息、智能与世界权力秩序从何而来？ |
...
2. **不知道，则易困于细节**——见树木而不见森林；系统能跑，却不知为谁创造价值。  
3. **不精术，则易止于空谈**——道理俱在，却无试点路径、无度量、无护栏。  
4. **有术而无道无势，则易速败**——用昨日的协作方式，承接今日被放大的吞吐。  
5. **有智而无略，则易工于器而疏于局**——交付变快，却不知在产业与市场中立于何处。

《大学》曰：「物有本末，事有终始，知所先后，则近道矣。」**势为先，道为中，术为成。**

预留区号，待文稿增多再独立成区，不提前拆库：

| 预留 | 主题 | 备注 |
|------|------|------|
| **60–69** | 文化与品牌 | `50-strategy` 中译介类若继续增加，再迁入 60 |
| **70–79** | 运营与质量 | — |
| **80–89** | 安全与风险 | — |
| **90–99** | 方法与元知识 | — |
...
- **`10`**：`10`–`12` 为计算 / 信息 / 智能技术史；`13` 为世界霸权秩序五百年编年（第一次工业革命按大分流重写；与 [55](./50-strategy/55-global-manufacturing-migration-chronicle.md) 制造业地理迁移互参）。  
...
- **`50`**：不是上下卷，而是同一问的多个切面。按编号：`50` 局、`51` 译、`52` 币、`53` 配、`54` 人、`55` 迁；口诀 **局、迁、译、币、配、人** 只记切面，不是文件顺序。产业如何被穿透（含 2026 交叠点与死亡之谷），意义如何跨文化传递，Token 如何成为智能经济的计量单位，资本如何在周期中配置，经理人如何在压力中被选出，制造业重心如何代际迁移。

---

## 3. 检索与阅读

检索口诀：**先编号定域，再触发器 / 摘要定读，再目录定点。** 不改文件名；按概念找文用「概念反查」。宽表格与 ASCII 图请用等宽字体、宽屏阅读。
...
| 编号 | 文稿 | 核心命题 | 触发器（何时读） |
|------|------|----------|------------------|
| 30 | [COBIT IT Governance Framework](./30-governance/30-cobit-it-governance-framework.md) | 技术是否创造可验证的经营结果 | COBIT、IT 治理 |
| 31 | [Platform Service Quality Case Study](./30-governance/31-platform-service-quality-case-study.md) | 平台质量如何被定义、证明并改成经营结果 | 平台质量、SERVQUAL |
...
按概念找编号（姊妹篇用「/」）：扫表 → 开对应文的「直接答案 / 摘要」→ 感兴趣再沿目录深入。
...
不必从头读到尾。先定角色与目标，再选一条路径；或先查「概念反查 / 触发器」，再读各篇摘要与「直接答案」。
...
2. **11** 信息如何被度量  
3. **12** 人工智能如何走到大模型  
4. **13** 五百年霸权转移与四次工业革命（取势）  
5. **20** 战略如何翻译为可执行安排  
6. **21** 架构代际迁移  
7. **43** 熵与复杂度如何转移（一般原理）  
8. **46** 系统思维：要素、连接、目标与反馈  
9. **22** 跨节点一致性取舍  
10. **23** 编排控制面原则  
11. **24** 数据面如何写表转发  
12. **40** 回到无状态与可组合  
...
1. **20** 战略如何翻译为安排（四大域 / 六层）  
2. **30** COBIT 如何落地  
3. **31** 平台质量如何度量与改进  
4. **50** AI 对治理与竞争的冲击（交叠点、死亡之谷）  
...
产业穿透、制造业迁移、跨文化译介、智能经济计价、资本配置与选人。
...
只读各篇摘要与开篇判断，约三十分钟可扫完全库；引起兴趣者再沿目录深入。
...
文件号为两位数：十位是区号（知识域），个位是域内序号。文件号 = 区号 + 个位序号，例如区号 `10`、序号 `3` → `13`。

| 规则 | 含义 |
|------|------|
| 文件号 | 聚类与阅读顺序；同域内按认知依赖递增 |
| 主题 | IT / 企业管理通行术语，不用口语或过宽的词 |
| 体裁 | 文章的知识形态，便于扫读与检索 |
| 一级标题 | 与文件名同向：文件名是检索键，标题是阅读入口，不必逐字相同，不得指到另一篇 |
| 摘要 | 目录前用一段话交代问题、主线与结论，不替代正文论证 |

新增时：先定区号，再取该域下一个空序号，最后用「主题 + 体裁」命名。例如下一篇史补篇为 `14-…-chronicle.md`（若 `13` 已占用），下一篇治理专论为 `32-…-framework.md`。

### 4.2 体裁

| 体裁 | 含义 | 适用 |
|------|------|------|
| `chronicle` | 编年叙事 | 长时段技术史或产业地理演进 |
...
- **读**：先问「为何此时出现」，再记「是什么」；先求结构，再攒事实。  
- **写**：关键判断对照可核验来源；提案与史实、标准与个人见解，边界分明。同一篇内引用体例须统一：`10` / `20` / `30` / `50` 多用 `[n]` 编号表；`40` / `51` / `52` 多用 `[^name]` 脚注。暂不强制全库改成一种。  
- **用**：知识若不进入决策与实践，不过是书架上的装饰。善始而不克终，与未学等。

---

## 5. 术语

缩写首次出现时标注全称。下表为全库首选写法。
...
索引里的「核心命题」是各篇入口。下面九句是跨篇之后仍站得住的判断——不替代正文，只作河床。论证与出处在对应文稿。
