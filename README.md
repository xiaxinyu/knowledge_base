...
│   └── 24-calico-networking-treatise.md
│       Calico 网络专论：节点即路由器、CNI 合同、veth、BGP 与包的路径
│
...
| 24 | [Calico Networking Treatise](./20-architecture/24-calico-networking-treatise.md) | Pod 网络如何用「节点即路由器」落地；kubelet 经 CNI 调用插件；Service 与 kube-proxy 如何分工 / 替代 |
